    ...
    public int onRunTask(TaskParams params) {
        ...
        if (urlStringBuilder != null) {
            ...
            try {
                ...
                Log.i("StockTaskService", getResponse);
                ...
                try {
                    ...
                    jsonObject = jsonObject.getJSONObject("query").getJSONObject("results").getJSONObject("quote");
                    ...
                    if ((jsonObject.getString("Bid")).equals("null")) {
                        ...
                        Log.i("StockTaskService", Utils.quoteJsonToContentVals(getResponse).toString());
                    }
